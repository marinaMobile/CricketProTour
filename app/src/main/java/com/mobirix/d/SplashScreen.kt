...
import com.mobirix.d.Constants.DL2
import com.mobirix.d.Constants.DL3
import com.mobirix.d.bbr.Invite
...
class SplashScreen : AppCompatActivity() {
    ...
    private fun aps() {
        ...
        AppsFlyerLib.getInstance()
            .init(Constants.AF_DEV_KEY, conversionDataListener, applicationContext)
